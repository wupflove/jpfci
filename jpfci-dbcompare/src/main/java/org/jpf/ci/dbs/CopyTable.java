 ...
 * @version 创建时间：2014年10月20日 下午9:21:10 类说明
 */
...
public class CopyTable {
  ...
  /**
   * @param args 被测试类名：TODO 被测试接口名:TODO 测试场景：TODO 前置参数：TODO 入参： 校验值： 测试备注： update 2014年10月20日
   */
  ...
  public CopyTable() {
    ...
    try {
      ...
      AiDBUtil.doClear(ConnSource);
      AiDBUtil.doClear(ConnDest);
    }
  }
}

 ...
 * 
 */
public class QInfoGrdOSE extends abstractQualityInfo
{
	...
	{
		// TODO Auto-generated method stub
		return "jdbc:mysql://10.1.228.41:43306/sonar";
	}
	...
	String getQuerySql()
	{
		...
		// TODO Auto-generated method stub
		String strSql="select t1.id prj_id,DATE_FORMAT(t2.build_date,'%Y-%m-%d') build_date, t1.name prj_name,t1.kee,"
				+" max(case t3.metric_id when 95 then t3.value end)blocker_violations,"
				...
				+" from projects t1,snapshots t2,project_measures t3 where t1.scope='PRJ' "
				+" and t1.enabled=1 and t1.id=t2.project_id and t2.islast=1  and t2.id=t3.snapshot_id"
				+" and t1.id not in (2100,4054,4053,4052,2114,4055)"
				+" AND t3.rule_id IS NULL  and t3.metric_id in (3,30,31,35,43,50,95,96,97) group by t1.id order by t1.name ";
		logger.info(strSql);
		return strSql;
	}
	...
	{
		String[][] strMerge={{"1","2101,2102,2103,2104,2107,2108,2114,2120,4479","platform"},{"2","2110,2111,2115","eshop"},{"3","2112,2113,2116","selfcare"},{"4","2117,2118,2119","kapala"},{"5","2122,2123,2124","agentview"}};
		return  strMerge;
	}

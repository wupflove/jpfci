 ...
 * 
 */
public class QInfoBiuBjSonar extends abstractQualityInfo
{
	...
	{
		// TODO Auto-generated method stub
		return "jdbc:mysql://10.1.241.51:4306/bjsonar";
	}
	...
	String getQuerySql()
	{
		...
		String strSql="select t1.id prj_id,DATE_FORMAT(t2.build_date,'%Y-%m-%d') build_date,"
				...
				+" where t1.scope='PRJ'   and t1.qualifier='TRK' and t1.name<>'PRJ_AVG' and t1.enabled=1 and t1.id=t2.project_id"
	...
	{
		// TODO Auto-generated method stub
		return "'BIU_YC','BIU_BAAS','BIU_ChangHong'";
	}

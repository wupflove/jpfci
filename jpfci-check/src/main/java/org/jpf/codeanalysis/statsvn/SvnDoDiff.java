...
package org.jpf.codeanalysis.statsvn;
...
import org.jpf.codeanalysis.SvnChangeInfo;
...
public class SvnDoDiff {
    ...
    public static void main(String[] args) throws Exception {
        ...
        getSvnDiff("http://130.51.23.250/bss_gd/crm/tags/tst_20170601/j2ee/BSSWEB","2018-01-01 00:00:00","2018-01-11 00:00:00",vChangeInfos,"public","123456");
        logger.info("ExcuteTime " + (System.currentTimeMillis() - start) + "ms");
    }

    final static String regEx = "['   ']+";
    
    public static void getSvnDiff(String strURL, String strStartDateTime,
            String strEndStartDateTime, Vector<SvnChangeInfo> vChangeInfos, String UserName,
            String PassWord) 
    {
        if (AiOsUtil.getInstance().isWindows())
        {
            getSvnDiff_Win(strURL, strStartDateTime, strEndStartDateTime, vChangeInfos, UserName, PassWord);
        }else {
            getSvnDiff_Linux(strURL, strStartDateTime, strEndStartDateTime, vChangeInfos, UserName, PassWord);
        }
    }
    /**
     * 
     ...
     */
    public static void getSvnDiff_Win(String strURL, String strStartDateTime,
            String strEndStartDateTime, Vector<SvnChangeInfo> vChangeInfos, String UserName,
            String PassWord) {
     ...
     * @return update 2017年5月16日
     */
    public static void getSvnDiff_Linux(String strURL, String strStartDateTime,
            String strEndStartDateTime, Vector<SvnChangeInfo> vChangeInfos, String UserName,
            String PassWord) {
        if (strURL == null || strURL.trim().length() == 0) {
            return;
     ...
     */
    public static void doSvnDiff() throws Exception {
        ...
        // 要比较的文件
        File compFile =
                new File("E:\\svn\\svn10.3.3.233\\newcrm_jx_modules\\newcrm_jx_adapter\\pom.xml");
        // 获得SVNDiffClient类的实例。
        ...
        diff.doDiff(compFile, SVNRevision.HEAD, SVNRevision.WORKING, SVNRevision.HEAD,
                SVNDepth.INFINITY, true, result, null);
        result.close();
        logger.info("比较的结果保存在E:/result.txt文件中！");
